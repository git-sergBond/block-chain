...
public class ChatEventListener {
     ...
     * Поддебажить клиентсю либу - кажется она не рабоатет
     *
     * Хабр
     ...
     *
     * WS auth https://www.baeldung.com/spring-security-websockets
     * WS simple example https://www.baeldung.com/websockets-spring
     *
